...
-- Ensure AiKnowledgeItems Table Exists
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.6 summary recommendation?')
BEGIN
    ...
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to 5.6 summary recommendation?', '5.6, summary, recommendation, user_manual', '**5.6 Summary Recommendation** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.5 financial p&l & invoice generation?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to 5.5 financial p&l & invoice generation?', '5.5, financial, p&l, &, invoice, generation, user_manual', '**5.5 Financial P&L & Invoice Generation** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.4 passenger rooming manifest & excursions pricing?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to 5.4 passenger rooming manifest & excursions pricing?', '5.4, passenger, rooming, manifest, &, excursions, pricing, user_manual', '**5.4 Passenger Rooming Manifest & Excursions Pricing** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.3 tour header, flight & hotel stay setup?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'Master Data', 'How to 5.3 tour header, flight & hotel stay setup?', '5.3, tour, header,, flight, &, hotel, stay, setup, user_manual', '**5.3 Tour Header, Flight & Hotel Stay Setup** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.2 master data setup (hotels, guides, excursions)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'Master Data', 'How to 5.2 master data setup (hotels, guides, excursions)?', '5.2, master, data, setup, (hotels,, guides,, excursions), user_manual', '**5.2 Master Data Setup (Hotels, Guides, Excursions)** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.1 client & project creation?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to 5.1 client & project creation?', '5.1, client, &, project, creation, user_manual', '**5.1 Client & Project Creation** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to chapter 5: side-by-side walkthrough: manual (`manualsample1`) vs excel upload (`excelsample1`)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to chapter 5: side-by-side walkthrough: manual (`manualsample1`) vs excel upload (`excelsample1`)?', 'chapter, 5:, side, by, walkthrough:, manual, (`manualsample1`), vs, excel, upload', '**Chapter 5: Side-by-Side Walkthrough: Manual (`ManualSample1`) vs Excel Upload (`ExcelSample1`)** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to chapter 4: troubleshooting & best practices?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to chapter 4: troubleshooting & best practices?', 'chapter, 4:, troubleshooting, &, best, practices, user_manual', '**Chapter 4: Troubleshooting & Best Practices** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3.2 excel upload workflow?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to 3.2 excel upload workflow?', '3.2, excel, upload, workflow, user_manual', '**3.2 Excel Upload Workflow** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3.1 manual entry workflow?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to 3.1 manual entry workflow?', '3.1, manual, entry, workflow, user_manual', '**3.1 Manual Entry Workflow** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to chapter 3: manual entry vs. excel upload workflow?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to chapter 3: manual entry vs. excel upload workflow?', 'chapter, 3:, manual, entry, vs., excel, upload, workflow, user_manual', '**Chapter 3: Manual Entry vs. Excel Upload Workflow** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.2 end-to-end workflow: entry to invoicing?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to 2.2 end-to-end workflow: entry to invoicing?', '2.2, end, to, workflow:, entry, invoicing, user_manual', '**2.2 End-to-End Workflow: Entry to Invoicing** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.1 the challenge?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'User Manual', 'How to 2.1 the challenge?', '2.1, the, challenge, user_manual', '**2.1 The Challenge** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1.2 how to create & manage master data?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'Master Data', 'How to 1.2 how to create & manage master data?', '1.2, how, to, create, &, manage, master, data, user_manual', '**1.2 How to Create & Manage Master Data** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1.1 why master data is required before operations?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'Master Data', 'How to 1.1 why master data is required before operations?', '1.1, why, master, data, is, required, before, operations, user_manual', '**1.1 Why Master Data Is Required Before Operations** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to uno erp — user manual & operational guide?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'user_manual.md', 'Master Data', 'How to uno erp — user manual & operational guide?', 'uno, erp, user, manual, &, operational, guide, user_manual', '**Uno ERP — User Manual & Operational Guide** (Source: `user_manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. copies & file locations?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Uno_Tour_Status_Transition_Process_Flows.md', 'User Manual', 'How to 4. copies & file locations?', '4., copies, &, file, locations, uno_tour_status_transition_process_flows', '**4. Copies & File Locations** (Source: `Uno_Tour_Status_Transition_Process_Flows.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to sla warning threshold matrix?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Uno_Tour_Status_Transition_Process_Flows.md', 'User Manual', 'How to sla warning threshold matrix?', 'sla, warning, threshold, matrix, uno_tour_status_transition_process_flows', '**SLA Warning Threshold Matrix** (Source: `Uno_Tour_Status_Transition_Process_Flows.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. automated sla warning notification rules?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Uno_Tour_Status_Transition_Process_Flows.md', 'Governance', 'How to 3. automated sla warning notification rules?', '3., automated, sla, warning, notification, rules, uno_tour_status_transition_process_flows', '**3. Automated SLA Warning Notification Rules** (Source: `Uno_Tour_Status_Transition_Process_Flows.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. transition criteria & checkpoint matrix?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Uno_Tour_Status_Transition_Process_Flows.md', 'Process Flow', 'How to 2. transition criteria & checkpoint matrix?', '2., transition, criteria, &, checkpoint, matrix, uno_tour_status_transition_process_flows', '**2. Transition Criteria & Checkpoint Matrix** (Source: `Uno_Tour_Status_Transition_Process_Flows.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. process overview & state machine diagram?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Uno_Tour_Status_Transition_Process_Flows.md', 'User Manual', 'How to 1. process overview & state machine diagram?', '1., process, overview, &, state, machine, diagram, uno_tour_status_transition_process_flows', '**1. Process Overview & State Machine Diagram** (Source: `Uno_Tour_Status_Transition_Process_Flows.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to uno_erp tour process status transition criteria & checkpoint specification?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Uno_Tour_Status_Transition_Process_Flows.md', 'Process Flow', 'How to uno_erp tour process status transition criteria & checkpoint specification?', 'uno_erp, tour, process, status, transition, criteria, &, checkpoint, specification, uno_tour_status_transition_process_flows', '**UNO_ERP Tour Process Status Transition Criteria & Checkpoint Specification** (Source: `Uno_Tour_Status_Transition_Process_Flows.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 7. troubleshooting & import best practices?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 7. troubleshooting & import best practices?', '7., troubleshooting, &, import, best, practices, uno_erp_user_manual', '**7. Troubleshooting & Import Best Practices** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 6. application screen field mappings?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 6. application screen field mappings?', '6., application, screen, field, mappings, uno_erp_user_manual', '**6. Application Screen Field Mappings** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.4 re-uploading completed sales files?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 5.4 re-uploading completed sales files?', '5.4, re, uploading, completed, sales, files, uno_erp_user_manual', '**5.4 Re-uploading Completed Sales Files** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.3 baseservices 10-column sheet structure?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 5.3 baseservices 10-column sheet structure?', '5.3, baseservices, 10, column, sheet, structure, uno_erp_user_manual', '**5.3 BaseServices 10-Column Sheet Structure** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.2 excursionsales sheet structure & interactive checkboxes?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 5.2 excursionsales sheet structure & interactive checkboxes?', '5.2, excursionsales, sheet, structure, &, interactive, checkboxes, uno_erp_user_manual', '**5.2 ExcursionSales Sheet Structure & Interactive Checkboxes** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5.1 downloading the passenger sales file?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 5.1 downloading the passenger sales file?', '5.1, downloading, the, passenger, sales, file, uno_erp_user_manual', '**5.1 Downloading the Passenger Sales File** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5. guide excursion & base sales workflow?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'Master Data', 'How to 5. guide excursion & base sales workflow?', '5., guide, excursion, &, base, sales, workflow, uno_erp_user_manual', '**5. Guide Excursion & Base Sales Workflow** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4.3 ui screen mapping?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 4.3 ui screen mapping?', '4.3, ui, screen, mapping, uno_erp_user_manual', '**4.3 UI Screen Mapping** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4.2 field extraction & normalization?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 4.2 field extraction & normalization?', '4.2, field, extraction, &, normalization, uno_erp_user_manual', '**4.2 Field Extraction & Normalization** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4.1 file name & format requirements?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 4.1 file name & format requirements?', '4.1, file, name, &, format, requirements, uno_erp_user_manual', '**4.1 File Name & Format Requirements** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. tour header & rooming file upload?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 4. tour header & rooming file upload?', '4., tour, header, &, rooming, file, upload, uno_erp_user_manual', '**4. Tour Header & Rooming File Upload** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3.2 automatic project creation via file import?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 3.2 automatic project creation via file import?', '3.2, automatic, project, creation, via, file, import, uno_erp_user_manual', '**3.2 Automatic Project Creation via File Import** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3.1 manual project creation?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 3.1 manual project creation?', '3.1, manual, project, creation, uno_erp_user_manual', '**3.1 Manual Project Creation** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. project creation & life cycle management?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 3. project creation & life cycle management?', '3., project, creation, &, life, cycle, management, uno_erp_user_manual', '**3. Project Creation & Life Cycle Management** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.2 upload workflow?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 2.2 upload workflow?', '2.2, upload, workflow, uno_erp_user_manual', '**2.2 Upload Workflow** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.1 excel master data file format?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'Master Data', 'How to 2.1 excel master data file format?', '2.1, excel, master, data, file, format, uno_erp_user_manual', '**2.1 Excel Master Data File Format** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. master data management & batch upload?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'Master Data', 'How to 2. master data management & batch upload?', '2., master, data, management, &, batch, upload, uno_erp_user_manual', '**2. Master Data Management & Batch Upload** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. overview & system architecture?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to 1. overview & system architecture?', '1., overview, &, system, architecture, uno_erp_user_manual', '**1. Overview & System Architecture** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to table of contents?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'User Manual', 'How to table of contents?', 'table, of, contents, uno_erp_user_manual', '**Table of Contents** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to uno erp - end-to-end comprehensive user manual & data import guide?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_User_Manual.md', 'Master Data', 'How to uno erp - end-to-end comprehensive user manual & data import guide?', 'uno, erp, end, to, comprehensive, user, manual, &, data, import', '**UNO ERP - End-to-End Comprehensive User Manual & Data Import Guide** (Source: `UNO_ERP_User_Manual.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to downloads & deliverables?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_Executive_KPI_Dashboard_Proposal.md', 'User Manual', 'How to downloads & deliverables?', 'downloads, &, deliverables, uno_erp_executive_kpi_dashboard_proposal', '**Downloads & Deliverables** (Source: `UNO_ERP_Executive_KPI_Dashboard_Proposal.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to implementation roadmap?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_Executive_KPI_Dashboard_Proposal.md', 'User Manual', 'How to implementation roadmap?', 'implementation, roadmap, uno_erp_executive_kpi_dashboard_proposal', '**Implementation Roadmap** (Source: `UNO_ERP_Executive_KPI_Dashboard_Proposal.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. growth, opportunities & ai kpis (6 kpis)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_Executive_KPI_Dashboard_Proposal.md', 'KPI Proposal', 'How to 4. growth, opportunities & ai kpis (6 kpis)?', '4., growth,, opportunities, &, ai, kpis, (6, kpis), uno_erp_executive_kpi_dashboard_proposal', '**4. Growth, Opportunities & AI KPIs (6 KPIs)** (Source: `UNO_ERP_Executive_KPI_Dashboard_Proposal.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. governance, compliance & risk kpis (6 kpis)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_Executive_KPI_Dashboard_Proposal.md', 'Governance', 'How to 3. governance, compliance & risk kpis (6 kpis)?', '3., governance,, compliance, &, risk, kpis, (6, kpis), uno_erp_executive_kpi_dashboard_proposal', '**3. Governance, Compliance & Risk KPIs (6 KPIs)** (Source: `UNO_ERP_Executive_KPI_Dashboard_Proposal.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. financial & profitability kpis (6 kpis)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_Executive_KPI_Dashboard_Proposal.md', 'KPI Proposal', 'How to 2. financial & profitability kpis (6 kpis)?', '2., financial, &, profitability, kpis, (6, kpis), uno_erp_executive_kpi_dashboard_proposal', '**2. Financial & Profitability KPIs (6 KPIs)** (Source: `UNO_ERP_Executive_KPI_Dashboard_Proposal.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. operational efficiency kpis (6 kpis)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_Executive_KPI_Dashboard_Proposal.md', 'KPI Proposal', 'How to 1. operational efficiency kpis (6 kpis)?', '1., operational, efficiency, kpis, (6, kpis), uno_erp_executive_kpi_dashboard_proposal', '**1. Operational Efficiency KPIs (6 KPIs)** (Source: `UNO_ERP_Executive_KPI_Dashboard_Proposal.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to executive summary?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_Executive_KPI_Dashboard_Proposal.md', 'User Manual', 'How to executive summary?', 'executive, summary, uno_erp_executive_kpi_dashboard_proposal', '**Executive Summary** (Source: `UNO_ERP_Executive_KPI_Dashboard_Proposal.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to uno_erp executive kpi dashboard proposal?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'UNO_ERP_Executive_KPI_Dashboard_Proposal.md', 'KPI Proposal', 'How to uno_erp executive kpi dashboard proposal?', 'uno_erp, executive, kpi, dashboard, proposal, uno_erp_executive_kpi_dashboard_proposal', '**UNO_ERP Executive KPI Dashboard Proposal** (Source: `UNO_ERP_Executive_KPI_Dashboard_Proposal.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. design & usability principles applied?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_ui_design.md', 'User Manual', 'How to 4. design & usability principles applied?', '4., design, &, usability, principles, applied, tour_calendar_ui_design', '**4. Design & Usability Principles Applied** (Source: `tour_calendar_ui_design.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. ui component hierarchy (mermaid diagram)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_ui_design.md', 'User Manual', 'How to 3. ui component hierarchy (mermaid diagram)?', '3., ui, component, hierarchy, (mermaid, diagram), tour_calendar_ui_design', '**3. UI Component Hierarchy (Mermaid Diagram)** (Source: `tour_calendar_ui_design.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.4. quick-view modal (hover/click)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_ui_design.md', 'User Manual', 'How to 2.4. quick-view modal (hover/click)?', '2.4., quick, view, modal, (hover/click), tour_calendar_ui_design', '**2.4. Quick-View Modal (Hover/Click)** (Source: `tour_calendar_ui_design.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.3. calendar grid & tour blocks?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_ui_design.md', 'User Manual', 'How to 2.3. calendar grid & tour blocks?', '2.3., calendar, grid, &, tour, blocks, tour_calendar_ui_design', '**2.3. Calendar Grid & Tour Blocks** (Source: `tour_calendar_ui_design.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.2. filter sidebar (left panel)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_ui_design.md', 'User Manual', 'How to 2.2. filter sidebar (left panel)?', '2.2., filter, sidebar, (left, panel), tour_calendar_ui_design', '**2.2. Filter Sidebar (Left Panel)** (Source: `tour_calendar_ui_design.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.1. top navigation bar?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_ui_design.md', 'User Manual', 'How to 2.1. top navigation bar?', '2.1., top, navigation, bar, tour_calendar_ui_design', '**2.1. Top Navigation Bar** (Source: `tour_calendar_ui_design.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to ascii wireframe (desktop/tablet landscape)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_ui_design.md', 'User Manual', 'How to ascii wireframe (desktop/tablet landscape)?', 'ascii, wireframe, (desktop/tablet, landscape), tour_calendar_ui_design', '**ASCII Wireframe (Desktop/Tablet Landscape)** (Source: `tour_calendar_ui_design.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. overall layout & structure?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_ui_design.md', 'User Manual', 'How to 1. overall layout & structure?', '1., overall, layout, &, structure, tour_calendar_ui_design', '**1. Overall Layout & Structure** (Source: `tour_calendar_ui_design.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to tour calendar ui/ux design specifications?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_ui_design.md', 'User Manual', 'How to tour calendar ui/ux design specifications?', 'tour, calendar, ui/ux, design, specifications, tour_calendar_ui_design', '**Tour Calendar UI/UX Design Specifications** (Source: `tour_calendar_ui_design.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 7. next steps & approvals?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'User Manual', 'How to 7. next steps & approvals?', '7., next, steps, &, approvals, tour_calendar_business_requirements', '**7. Next Steps & Approvals** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 6. non-functional requirements?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'User Manual', 'How to 6. non-functional requirements?', '6., non, functional, requirements, tour_calendar_business_requirements', '**6. Non-Functional Requirements** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to fr3: availability and status indicators?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'Process Flow', 'How to fr3: availability and status indicators?', 'fr3:, availability, and, status, indicators, tour_calendar_business_requirements', '**FR3: Availability and Status Indicators** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to fr2: filtering mechanism?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'User Manual', 'How to fr2: filtering mechanism?', 'fr2:, filtering, mechanism, tour_calendar_business_requirements', '**FR2: Filtering Mechanism** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to fr1: calendar interface?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'User Manual', 'How to fr1: calendar interface?', 'fr1:, calendar, interface, tour_calendar_business_requirements', '**FR1: Calendar Interface** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to out of scope (for phase 1)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'User Manual', 'How to out of scope (for phase 1)?', 'out, of, scope, (for, phase, 1), tour_calendar_business_requirements', '**Out of Scope (For Phase 1)** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to in scope?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'User Manual', 'How to in scope?', 'in, scope, tour_calendar_business_requirements', '**In Scope** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. competitive analysis & strategic fit?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'User Manual', 'How to 3. competitive analysis & strategic fit?', '3., competitive, analysis, &, strategic, fit, tour_calendar_business_requirements', '**3. Competitive Analysis & Strategic Fit** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. business objectives?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'User Manual', 'How to 2. business objectives?', '2., business, objectives, tour_calendar_business_requirements', '**2. Business Objectives** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. executive summary?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_business_requirements.md', 'User Manual', 'How to 1. executive summary?', '1., executive, summary, tour_calendar_business_requirements', '**1. Executive Summary** (Source: `tour_calendar_business_requirements.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-api-004] reschedule tour validation?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'User Manual', 'How to [cal-api-004] reschedule tour validation?', '[cal, api, 004], reschedule, tour, validation, tour_calendar_backlog', '**[CAL-API-004] Reschedule Tour Validation** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-api-003] role-based access control (rbac) data masking?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'User Manual', 'How to [cal-api-003] role-based access control (rbac) data masking?', '[cal, api, 003], role, based, access, control, (rbac), data, masking', '**[CAL-API-003] Role-Based Access Control (RBAC) Data Masking** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-api-002] filter calendar data?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'User Manual', 'How to [cal-api-002] filter calendar data?', '[cal, api, 002], filter, calendar, data, tour_calendar_backlog', '**[CAL-API-002] Filter Calendar Data** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-api-001] fetch calendar data?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'User Manual', 'How to [cal-api-001] fetch calendar data?', '[cal, api, 001], fetch, calendar, data, tour_calendar_backlog', '**[CAL-API-001] Fetch Calendar Data** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-ui-006] drag-and-drop rescheduling?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'User Manual', 'How to [cal-ui-006] drag-and-drop rescheduling?', '[cal, ui, 006], drag, and, drop, rescheduling, tour_calendar_backlog', '**[CAL-UI-006] Drag-and-Drop Rescheduling** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-ui-005] multi-select resource filtering?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'User Manual', 'How to [cal-ui-005] multi-select resource filtering?', '[cal, ui, 005], multi, select, resource, filtering, tour_calendar_backlog', '**[CAL-UI-005] Multi-select Resource Filtering** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-ui-004] double-booking visual warnings?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'User Manual', 'How to [cal-ui-004] double-booking visual warnings?', '[cal, ui, 004], double, booking, visual, warnings, tour_calendar_backlog', '**[CAL-UI-004] Double-booking Visual Warnings** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-ui-003] status and availability indicators?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'Process Flow', 'How to [cal-ui-003] status and availability indicators?', '[cal, ui, 003], status, and, availability, indicators, tour_calendar_backlog', '**[CAL-UI-003] Status and Availability Indicators** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-ui-002] tour block quick-view?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'User Manual', 'How to [cal-ui-002] tour block quick-view?', '[cal, ui, 002], tour, block, quick, view, tour_calendar_backlog', '**[CAL-UI-002] Tour Block Quick-View** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [cal-ui-001] multi-view calendar display?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'tour_calendar_backlog.md', 'User Manual', 'How to [cal-ui-001] multi-view calendar display?', '[cal, ui, 001], multi, view, calendar, display, tour_calendar_backlog', '**[CAL-UI-001] Multi-View Calendar Display** (Source: `tour_calendar_backlog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 📈 3. consolidated summary metrics?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'PROJECT_EFFORT_AND_TOKEN_ANALYTICS.md', 'User Manual', 'How to 📈 3. consolidated summary metrics?', '📈, 3., consolidated, summary, metrics, project_effort_and_token_analytics', '**📈 3. Consolidated Summary Metrics** (Source: `PROJECT_EFFORT_AND_TOKEN_ANALYTICS.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 🧮 2. total ai token consumption & financial cost ($ usd)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'PROJECT_EFFORT_AND_TOKEN_ANALYTICS.md', 'User Manual', 'How to 🧮 2. total ai token consumption & financial cost ($ usd)?', '🧮, 2., total, ai, token, consumption, &, financial, cost, ($', '**🧮 2. Total AI Token Consumption & Financial Cost ($ USD)** (Source: `PROJECT_EFFORT_AND_TOKEN_ANALYTICS.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to ⏱️ 1. total development effort (hours)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'PROJECT_EFFORT_AND_TOKEN_ANALYTICS.md', 'User Manual', 'How to ⏱️ 1. total development effort (hours)?', '⏱️, 1., total, development, effort, (hours), project_effort_and_token_analytics', '**⏱️ 1. Total Development Effort (Hours)** (Source: `PROJECT_EFFORT_AND_TOKEN_ANALYTICS.md`)
...
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'PROJECT_EFFORT_AND_TOKEN_ANALYTICS.md', 'User Manual', 'How to 🌟 executive summary?', '🌟, executive, summary, project_effort_and_token_analytics', '**🌟 Executive Summary** (Source: `PROJECT_EFFORT_AND_TOKEN_ANALYTICS.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 7. business approvals & next steps?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to 7. business approvals & next steps?', '7., business, approvals, &, next, steps, ba_excel_data_integration', '**7. Business Approvals & Next Steps** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 6. compliance & data privacy (gdpr / kvkk)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to 6. compliance & data privacy (gdpr / kvkk)?', '6., compliance, &, data, privacy, (gdpr, /, kvkk), ba_excel_data_integration', '**6. Compliance & Data Privacy (GDPR / KVKK)** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5. competitor comparison & strategic gaps?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to 5. competitor comparison & strategic gaps?', '5., competitor, comparison, &, strategic, gaps, ba_excel_data_integration', '**5. Competitor Comparison & Strategic Gaps** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to model 2: `passengerexcursion` (or `excursionsale`)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to model 2: `passengerexcursion` (or `excursionsale`)?', 'model, 2:, `passengerexcursion`, (or, `excursionsale`), ba_excel_data_integration', '**Model 2: `PassengerExcursion` (or `ExcursionSale`)** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to model 1: `passenger`?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to model 1: `passenger`?', 'model, 1:, `passenger`, ba_excel_data_integration', '**Model 1: `Passenger`** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. integration proposal & data modeling?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to 4. integration proposal & data modeling?', '4., integration, proposal, &, data, modeling, ba_excel_data_integration', '**4. Integration Proposal & Data Modeling** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to b. tur satis / excursion sales lists (e.g., `tur_satis_19072025.xlsx`)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to b. tur satis / excursion sales lists (e.g., `tur_satis_19072025.xlsx`)?', 'b., tur, satis, /, excursion, sales, lists, (e.g.,, `tur_satis_19072025.xlsx`), ba_excel_data_integration', '**B. Tur Satis / Excursion Sales Lists (e.g., `Tur_satis_19072025.xlsx`)** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to a. rooming lists (e.g., `vi 1007 bvsp rooming.xlsx`, `final rooming list...`)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to a. rooming lists (e.g., `vi 1007 bvsp rooming.xlsx`, `final rooming list...`)?', 'a., rooming, lists, (e.g.,, `vi, 1007, bvsp, rooming.xlsx`,, `final, list...`)', '**A. Rooming Lists (e.g., `VI 1007 BVSP rooming.xlsx`, `Final Rooming list...`)** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.2 tourservices & tours sheets?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to 2.2 tourservices & tours sheets?', '2.2, tourservices, &, tours, sheets, ba_excel_data_integration', '**2.2 TourServices & Tours Sheets** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.1 hotels sheet (master & contract data)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'Master Data', 'How to 2.1 hotels sheet (master & contract data)?', '2.1, hotels, sheet, (master, &, contract, data), ba_excel_data_integration', '**2.1 Hotels Sheet (Master & Contract Data)** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. sprint 1 excel import template updates?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to 2. sprint 1 excel import template updates?', '2., sprint, 1, excel, import, template, updates, ba_excel_data_integration', '**2. Sprint 1 Excel Import Template Updates** (Source: `BA_Excel_Data_Integration.md`)
...
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to 1. executive summary?', '1., executive, summary, ba_excel_data_integration', '**1. Executive Summary** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to business analysis report: excel data integration strategy?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'BA_Excel_Data_Integration.md', 'User Manual', 'How to business analysis report: excel data integration strategy?', 'business, analysis, report:, excel, data, integration, strategy, ba_excel_data_integration', '**Business Analysis Report: Excel Data Integration Strategy** (Source: `BA_Excel_Data_Integration.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to sprint 3: the operational dashboard?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Backlog_Sprints_1_3.md', 'KPI Proposal', 'How to sprint 3: the operational dashboard?', 'sprint, 3:, the, operational, dashboard, backlog_sprints_1_3', '**Sprint 3: The Operational Dashboard** (Source: `Backlog_Sprints_1_3.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to sprint 2: multi-city itineraries & pipeline?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Backlog_Sprints_1_3.md', 'User Manual', 'How to sprint 2: multi-city itineraries & pipeline?', 'sprint, 2:, multi, city, itineraries, &, pipeline, backlog_sprints_1_3', '**Sprint 2: Multi-City Itineraries & Pipeline** (Source: `Backlog_Sprints_1_3.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to sprint 1: core master data & crm?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Backlog_Sprints_1_3.md', 'Master Data', 'How to sprint 1: core master data & crm?', 'sprint, 1:, core, master, data, &, crm, backlog_sprints_1_3', '**Sprint 1: Core Master Data & CRM** (Source: `Backlog_Sprints_1_3.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to uno erp: backlog & sprint planning (mvp)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', 'Backlog_Sprints_1_3.md', 'User Manual', 'How to uno erp: backlog & sprint planning (mvp)?', 'uno, erp:, backlog, &, sprint, planning, (mvp), backlog_sprints_1_3', '**UNO ERP: Backlog & Sprint Planning (MVP)** (Source: `Backlog_Sprints_1_3.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5. ci/cd reliability & flakiness controls?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '20_User_Management_Test_Plans.md', 'User Manual', 'How to 5. ci/cd reliability & flakiness controls?', '5., ci/cd, reliability, &, flakiness, controls, 20_user_management_test_plans', '**5. CI/CD Reliability & Flakiness Controls** (Source: `20_User_Management_Test_Plans.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to api validation example?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '20_User_Management_Test_Plans.md', 'User Manual', 'How to api validation example?', 'api, validation, example, 20_user_management_test_plans', '**API Validation Example** (Source: `20_User_Management_Test_Plans.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. api validation strategies?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '20_User_Management_Test_Plans.md', 'User Manual', 'How to 4. api validation strategies?', '4., api, validation, strategies, 20_user_management_test_plans', '**4. API Validation Strategies** (Source: `20_User_Management_Test_Plans.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to idempotent test example?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '20_User_Management_Test_Plans.md', 'User Manual', 'How to idempotent test example?', 'idempotent, test, example, 20_user_management_test_plans', '**Idempotent Test Example** (Source: `20_User_Management_Test_Plans.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to pom implementation example (playwright)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '20_User_Management_Test_Plans.md', 'User Manual', 'How to pom implementation example (playwright)?', 'pom, implementation, example, (playwright), 20_user_management_test_plans', '**POM Implementation Example (Playwright)** (Source: `20_User_Management_Test_Plans.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. ui automation & page object models (pom)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '20_User_Management_Test_Plans.md', 'User Manual', 'How to 3. ui automation & page object models (pom)?', '3., ui, automation, &, page, object, models, (pom), 20_user_management_test_plans', '**3. UI Automation & Page Object Models (POM)** (Source: `20_User_Management_Test_Plans.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. test repository architecture?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '20_User_Management_Test_Plans.md', 'User Manual', 'How to 2. test repository architecture?', '2., test, repository, architecture, 20_user_management_test_plans', '**2. Test Repository Architecture** (Source: `20_User_Management_Test_Plans.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to test automation matrix?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '20_User_Management_Test_Plans.md', 'User Manual', 'How to test automation matrix?', 'test, automation, matrix, 20_user_management_test_plans', '**Test Automation Matrix** (Source: `20_User_Management_Test_Plans.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. test strategy & scope?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '20_User_Management_Test_Plans.md', 'User Manual', 'How to 1. test strategy & scope?', '1., test, strategy, &, scope, 20_user_management_test_plans', '**1. Test Strategy & Scope** (Source: `20_User_Management_Test_Plans.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 7. business approvals?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to 7. business approvals?', '7., business, approvals, 19_user_management_rbac', '**7. Business Approvals** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 6. suggestions & improvements?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to 6. suggestions & improvements?', '6., suggestions, &, improvements, 19_user_management_rbac', '**6. Suggestions & Improvements** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5. scope definition: lean mvp (sprint 1)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to 5. scope definition: lean mvp (sprint 1)?', '5., scope, definition:, lean, mvp, (sprint, 1), 19_user_management_rbac', '**5. Scope Definition: Lean MVP (Sprint 1)** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. module-level view & edit rights strategy (rbac)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to 4. module-level view & edit rights strategy (rbac)?', '4., module, level, view, &, edit, rights, strategy, (rbac), 19_user_management_rbac', '**4. Module-Level View & Edit Rights Strategy (RBAC)** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to cross-industry considerations?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to cross-industry considerations?', 'cross, industry, considerations, 19_user_management_rbac', '**Cross-Industry Considerations** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to gdpr (general data protection regulation)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to gdpr (general data protection regulation)?', 'gdpr, (general, data, protection, regulation), 19_user_management_rbac', '**GDPR (General Data Protection Regulation)** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. compliance & data privacy requirements?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to 3. compliance & data privacy requirements?', '3., compliance, &, data, privacy, requirements, 19_user_management_rbac', '**3. Compliance & Data Privacy Requirements** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to profile strategy?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to profile strategy?', 'profile, strategy, 19_user_management_rbac', '**Profile Strategy** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to competitive parity requirements?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to competitive parity requirements?', 'competitive, parity, requirements, 19_user_management_rbac', '**Competitive Parity Requirements** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. strategic & competitive analysis?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to 2. strategic & competitive analysis?', '2., strategic, &, competitive, analysis, 19_user_management_rbac', '**2. Strategic & Competitive Analysis** (Source: `19_User_Management_RBAC.md`)
...
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to 1. executive summary?', '1., executive, summary, 19_user_management_rbac', '**1. Executive Summary** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to business case review: unoerp user management module (sprint 0)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '19_User_Management_RBAC.md', 'User Manual', 'How to business case review: unoerp user management module (sprint 0)?', 'business, case, review:, unoerp, user, management, module, (sprint, 0), 19_user_management_rbac', '**Business Case Review: UnoERP User Management Module (Sprint 0)** (Source: `19_User_Management_RBAC.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to user story 2.4: safe staff operations?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to user story 2.4: safe staff operations?', 'user, story, 2.4:, safe, staff, operations, 18_user_management_epic_stories', '**User Story 2.4: Safe Staff Operations** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to user story 2.3: enforce managerial oversight?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to user story 2.3: enforce managerial oversight?', 'user, story, 2.3:, enforce, managerial, oversight, 18_user_management_epic_stories', '**User Story 2.3: Enforce Managerial Oversight** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to user story 2.2: configure granular module-level rights?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to user story 2.2: configure granular module-level rights?', 'user, story, 2.2:, configure, granular, module, level, rights, 18_user_management_epic_stories', '**User Story 2.2: Configure Granular Module-Level Rights** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to user story 2.1: assign and manage base roles?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to user story 2.1: assign and manage base roles?', 'user, story, 2.1:, assign, and, manage, base, roles, 18_user_management_epic_stories', '**User Story 2.1: Assign and Manage Base Roles** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to feature 2: role & module-level permissions control?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to feature 2: role & module-level permissions control?', 'feature, 2:, role, &, module, level, permissions, control, 18_user_management_epic_stories', '**Feature 2: Role & Module-Level Permissions Control** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to user story 1.3: user profile management?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to user story 1.3: user profile management?', 'user, story, 1.3:, profile, management, 18_user_management_epic_stories', '**User Story 1.3: User Profile Management** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to user story 1.2: edit and deactivate users?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to user story 1.2: edit and deactivate users?', 'user, story, 1.2:, edit, and, deactivate, users, 18_user_management_epic_stories', '**User Story 1.2: Edit and Deactivate Users** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to user story 1.1: create new system users?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to user story 1.1: create new system users?', 'user, story, 1.1:, create, new, system, users, 18_user_management_epic_stories', '**User Story 1.1: Create New System Users** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to feature 1: user account lifecycle management?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to feature 1: user account lifecycle management?', 'feature, 1:, user, account, lifecycle, management, 18_user_management_epic_stories', '**Feature 1: User Account Lifecycle Management** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to epic: user management module?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '18_User_Management_Epic_Stories.md', 'User Manual', 'How to epic: user management module?', 'epic:, user, management, module, 18_user_management_epic_stories', '**Epic: User Management Module** (Source: `18_User_Management_Epic_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. financial workflow?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '17_Domain_Schema_and_Workflow.md', 'User Manual', 'How to 3. financial workflow?', '3., financial, workflow, 17_domain_schema_and_workflow', '**3. Financial Workflow** (Source: `17_Domain_Schema_and_Workflow.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.4 financial & p&l entities?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '17_Domain_Schema_and_Workflow.md', 'User Manual', 'How to 2.4 financial & p&l entities?', '2.4, financial, &, p&l, entities, 17_domain_schema_and_workflow', '**2.4 Financial & P&L Entities** (Source: `17_Domain_Schema_and_Workflow.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.3 master data entities?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '17_Domain_Schema_and_Workflow.md', 'Master Data', 'How to 2.3 master data entities?', '2.3, master, data, entities, 17_domain_schema_and_workflow', '**2.3 Master Data Entities** (Source: `17_Domain_Schema_and_Workflow.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.2 data import staging (in-memory)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '17_Domain_Schema_and_Workflow.md', 'User Manual', 'How to 2.2 data import staging (in-memory)?', '2.2, data, import, staging, (in, memory), 17_domain_schema_and_workflow', '**2.2 Data Import Staging (In-Memory)** (Source: `17_Domain_Schema_and_Workflow.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2.1 project (tour)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '17_Domain_Schema_and_Workflow.md', 'User Manual', 'How to 2.1 project (tour)?', '2.1, project, (tour), 17_domain_schema_and_workflow', '**2.1 Project (Tour)** (Source: `17_Domain_Schema_and_Workflow.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. core entity relationship overview?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '17_Domain_Schema_and_Workflow.md', 'User Manual', 'How to 1. core entity relationship overview?', '1., core, entity, relationship, overview, 17_domain_schema_and_workflow', '**1. Core Entity Relationship Overview** (Source: `17_Domain_Schema_and_Workflow.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to phase 3: mobile & field operations (months 5+)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '10_Release_Roadmap_and_Delivery_Plan.md', 'User Manual', 'How to phase 3: mobile & field operations (months 5+)?', 'phase, 3:, mobile, &, field, operations, (months, 5+), 10_release_roadmap_and_delivery_plan', '**Phase 3: Mobile & Field Operations (Months 5+)** (Source: `10_Release_Roadmap_and_Delivery_Plan.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to phase 2: finance & automation (months 3-4)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '10_Release_Roadmap_and_Delivery_Plan.md', 'User Manual', 'How to phase 2: finance & automation (months 3-4)?', 'phase, 2:, finance, &, automation, (months, 3, 4), 10_release_roadmap_and_delivery_plan', '**Phase 2: Finance & Automation (Months 3-4)** (Source: `10_Release_Roadmap_and_Delivery_Plan.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to phase 1: the core mvp (months 1-2)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '10_Release_Roadmap_and_Delivery_Plan.md', 'User Manual', 'How to phase 1: the core mvp (months 1-2)?', 'phase, 1:, the, core, mvp, (months, 1, 2), 10_release_roadmap_and_delivery_plan', '**Phase 1: The Core MVP (Months 1-2)** (Source: `10_Release_Roadmap_and_Delivery_Plan.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. operations & maintenance?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '09_Architecture_Deployment_and_Operations.md', 'User Manual', 'How to 3. operations & maintenance?', '3., operations, &, maintenance, 09_architecture_deployment_and_operations', '**3. Operations & Maintenance** (Source: `09_Architecture_Deployment_and_Operations.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. on-premise deployment strategy?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '09_Architecture_Deployment_and_Operations.md', 'User Manual', 'How to 2. on-premise deployment strategy?', '2., on, premise, deployment, strategy, 09_architecture_deployment_and_operations', '**2. On-Premise Deployment Strategy** (Source: `09_Architecture_Deployment_and_Operations.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1.2 backend (api)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '09_Architecture_Deployment_and_Operations.md', 'User Manual', 'How to 1.2 backend (api)?', '1.2, backend, (api), 09_architecture_deployment_and_operations', '**1.2 Backend (API)** (Source: `09_Architecture_Deployment_and_Operations.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1.1 frontend (ui)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '09_Architecture_Deployment_and_Operations.md', 'User Manual', 'How to 1.1 frontend (ui)?', '1.1, frontend, (ui), 09_architecture_deployment_and_operations', '**1.1 Frontend (UI)** (Source: `09_Architecture_Deployment_and_Operations.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. system architecture?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '09_Architecture_Deployment_and_Operations.md', 'User Manual', 'How to 1. system architecture?', '1., system, architecture, 09_architecture_deployment_and_operations', '**1. System Architecture** (Source: `09_Architecture_Deployment_and_Operations.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to test suite 3: dashboard payables?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '06_UI_API_Acceptance_Test_Cases.md', 'KPI Proposal', 'How to test suite 3: dashboard payables?', 'test, suite, 3:, dashboard, payables, 06_ui_api_acceptance_test_cases', '**Test Suite 3: Dashboard Payables** (Source: `06_UI_API_Acceptance_Test_Cases.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to test suite 2: extra tours financial calculation?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '06_UI_API_Acceptance_Test_Cases.md', 'User Manual', 'How to test suite 2: extra tours financial calculation?', 'test, suite, 2:, extra, tours, financial, calculation, 06_ui_api_acceptance_test_cases', '**Test Suite 2: Extra Tours Financial Calculation** (Source: `06_UI_API_Acceptance_Test_Cases.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to test suite 1: project & city stay creation?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '06_UI_API_Acceptance_Test_Cases.md', 'User Manual', 'How to test suite 1: project & city stay creation?', 'test, suite, 1:, project, &, city, stay, creation, 06_ui_api_acceptance_test_cases', '**Test Suite 1: Project & City Stay Creation** (Source: `06_UI_API_Acceptance_Test_Cases.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-042] budget variance workflow?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'User Manual', 'How to [api-us-042] budget variance workflow?', '[api, us, 042], budget, variance, workflow, 05_api_user_stories', '**[API-US-042] Budget Variance Workflow** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-040 & 041] vendor payments & reconciliations?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'User Manual', 'How to [api-us-040 & 041] vendor payments & reconciliations?', '[api, us, 040, &, 041], vendor, payments, reconciliations, 05_api_user_stories', '**[API-US-040 & 041] Vendor Payments & Reconciliations** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-032] unpaid payables?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'User Manual', 'How to [api-us-032] unpaid payables?', '[api, us, 032], unpaid, payables, 05_api_user_stories', '**[API-US-032] Unpaid Payables** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-031] extra tour margin calculation?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'User Manual', 'How to [api-us-031] extra tour margin calculation?', '[api, us, 031], extra, tour, margin, calculation, 05_api_user_stories', '**[API-US-031] Extra Tour Margin Calculation** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-030] transport dependencies?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'User Manual', 'How to [api-us-030] transport dependencies?', '[api, us, 030], transport, dependencies, 05_api_user_stories', '**[API-US-030] Transport Dependencies** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-020 to 022] schema-driven import?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'User Manual', 'How to [api-us-020 to 022] schema-driven import?', '[api, us, 020, to, 022], schema, driven, import, 05_api_user_stories', '**[API-US-020 to 022] Schema-driven Import** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-010 to 012] project crud & currency?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'User Manual', 'How to [api-us-010 to 012] project crud & currency?', '[api, us, 010, to, 012], project, crud, &, currency, 05_api_user_stories', '**[API-US-010 to 012] Project CRUD & Currency** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-005 & 006] financial kpis & charts?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'KPI Proposal', 'How to [api-us-005 & 006] financial kpis & charts?', '[api, us, 005, &, 006], financial, kpis, charts, 05_api_user_stories', '**[API-US-005 & 006] Financial KPIs & Charts** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-004] guide availability?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'Master Data', 'How to [api-us-004] guide availability?', '[api, us, 004], guide, availability, 05_api_user_stories', '**[API-US-004] Guide Availability** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-003] lightweight project summary?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'User Manual', 'How to [api-us-003] lightweight project summary?', '[api, us, 003], lightweight, project, summary, 05_api_user_stories', '**[API-US-003] Lightweight Project Summary** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-002] global alerts?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'User Manual', 'How to [api-us-002] global alerts?', '[api, us, 002], global, alerts, 05_api_user_stories', '**[API-US-002] Global Alerts** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [api-us-001] dashboard timeline?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '05_API_User_Stories.md', 'KPI Proposal', 'How to [api-us-001] dashboard timeline?', '[api, us, 001], dashboard, timeline, 05_api_user_stories', '**[API-US-001] Dashboard Timeline** (Source: `05_API_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-052] budget variance approvals?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'User Manual', 'How to [ui-us-052] budget variance approvals?', '[ui, us, 052], budget, variance, approvals, 04_ui_user_stories', '**[UI-US-052] Budget Variance Approvals** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-050 & 051] vendor payments & petty cash?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'User Manual', 'How to [ui-us-050 & 051] vendor payments & petty cash?', '[ui, us, 050, &, 051], vendor, payments, petty, cash, 04_ui_user_stories', '**[UI-US-050 & 051] Vendor Payments & Petty Cash** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-040] extra tour sales?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'User Manual', 'How to [ui-us-040] extra tour sales?', '[ui, us, 040], extra, tour, sales, 04_ui_user_stories', '**[UI-US-040] Extra Tour Sales** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-030 to 032] master data directories?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'Master Data', 'How to [ui-us-030 to 032] master data directories?', '[ui, us, 030, to, 032], master, data, directories, 04_ui_user_stories', '**[UI-US-030 to 032] Master Data Directories** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-020 to 023] project creation & itinerary building?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'User Manual', 'How to [ui-us-020 to 023] project creation & itinerary building?', '[ui, us, 020, to, 023], project, creation, &, itinerary, building', '**[UI-US-020 to 023] Project Creation & Itinerary Building** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-010 & 011] excel import & staging grid?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'User Manual', 'How to [ui-us-010 & 011] excel import & staging grid?', '[ui, us, 010, &, 011], excel, import, staging, grid, 04_ui_user_stories', '**[UI-US-010 & 011] Excel Import & Staging Grid** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-006 & 007] dashboard financial kpis & charts?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'KPI Proposal', 'How to [ui-us-006 & 007] dashboard financial kpis & charts?', '[ui, us, 006, &, 007], dashboard, financial, kpis, charts, 04_ui_user_stories', '**[UI-US-006 & 007] Dashboard Financial KPIs & Charts** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-005] guide overview grid?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'Master Data', 'How to [ui-us-005] guide overview grid?', '[ui, us, 005], guide, overview, grid, 04_ui_user_stories', '**[UI-US-005] Guide Overview Grid** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-004] quick create sidebar?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'User Manual', 'How to [ui-us-004] quick create sidebar?', '[ui, us, 004], quick, create, sidebar, 04_ui_user_stories', '**[UI-US-004] Quick Create Sidebar** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-003] slide-out project details?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'User Manual', 'How to [ui-us-003] slide-out project details?', '[ui, us, 003], slide, out, project, details, 04_ui_user_stories', '**[UI-US-003] Slide-out Project Details** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-002] global alerts panel?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'User Manual', 'How to [ui-us-002] global alerts panel?', '[ui, us, 002], global, alerts, panel, 04_ui_user_stories', '**[UI-US-002] Global Alerts Panel** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to [ui-us-001] gantt timeline for active projects?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '04_UI_User_Stories.md', 'User Manual', 'How to [ui-us-001] gantt timeline for active projects?', '[ui, us, 001], gantt, timeline, for, active, projects, 04_ui_user_stories', '**[UI-US-001] Gantt Timeline for Active Projects** (Source: `04_UI_User_Stories.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 6. finance?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '03_API_Feature_Catalog.md', 'User Manual', 'How to 6. finance?', '6., finance, 03_api_feature_catalog', '**6. Finance** (Source: `03_API_Feature_Catalog.md`)

*   **API-F-060:** `GET /api/finance/payables` - Fetch upcoming supplier payments.', '/tours', 'View Tours Grid', 1, GETUTCDATE(), GETUTCDATE());
END
GO

IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5. master data api?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '03_API_Feature_Catalog.md', 'Master Data', 'How to 5. master data api?', '5., master, data, api, 03_api_feature_catalog', '**5. Master Data API** (Source: `03_API_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. city stays & services api?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '03_API_Feature_Catalog.md', 'User Manual', 'How to 4. city stays & services api?', '4., city, stays, &, services, api, 03_api_feature_catalog', '**4. City Stays & Services API** (Source: `03_API_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. generic data import api?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '03_API_Feature_Catalog.md', 'User Manual', 'How to 3. generic data import api?', '3., generic, data, import, api, 03_api_feature_catalog', '**3. Generic Data Import API** (Source: `03_API_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. projects & pipeline api?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '03_API_Feature_Catalog.md', 'User Manual', 'How to 2. projects & pipeline api?', '2., projects, &, pipeline, api, 03_api_feature_catalog', '**2. Projects & Pipeline API** (Source: `03_API_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. dashboard aggregate apis?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '03_API_Feature_Catalog.md', 'KPI Proposal', 'How to 1. dashboard aggregate apis?', '1., dashboard, aggregate, apis, 03_api_feature_catalog', '**1. Dashboard Aggregate APIs** (Source: `03_API_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to api feature catalog: uno erp?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '03_API_Feature_Catalog.md', 'User Manual', 'How to api feature catalog: uno erp?', 'api, feature, catalog:, uno, erp, 03_api_feature_catalog', '**API Feature Catalog: UNO ERP** (Source: `03_API_Feature_Catalog.md`)

This document indexes all major backend API endpoints.', '/tours', 'View Tours Grid', 1, GETUTCDATE(), GETUTCDATE());
END
GO

IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 8. finance module?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '02_UI_Feature_Catalog.md', 'User Manual', 'How to 8. finance module?', '8., finance, module, 02_ui_feature_catalog', '**8. Finance Module** (Source: `02_UI_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 7. master data & supplier modules?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '02_UI_Feature_Catalog.md', 'Master Data', 'How to 7. master data & supplier modules?', '7., master, data, &, supplier, modules, 02_ui_feature_catalog', '**7. Master Data & Supplier Modules** (Source: `02_UI_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 6. project management module?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '02_UI_Feature_Catalog.md', 'User Manual', 'How to 6. project management module?', '6., project, management, module, 02_ui_feature_catalog', '**6. Project Management Module** (Source: `02_UI_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5. generic excel import module?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '02_UI_Feature_Catalog.md', 'User Manual', 'How to 5. generic excel import module?', '5., generic, excel, import, module, 02_ui_feature_catalog', '**5. Generic Excel Import Module** (Source: `02_UI_Feature_Catalog.md`)

*   **UI-F-040: Dynamic Data Mapper:** Upload, Map Columns, Edit Staging Grid, Save.', '/tours', 'View Tours Grid', 1, GETUTCDATE(), GETUTCDATE());
END
GO

IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. sales pipeline module?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '02_UI_Feature_Catalog.md', 'User Manual', 'How to 4. sales pipeline module?', '4., sales, pipeline, module, 02_ui_feature_catalog', '**4. Sales Pipeline Module** (Source: `02_UI_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. contextual slide-out panels (drill-down)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '02_UI_Feature_Catalog.md', 'User Manual', 'How to 3. contextual slide-out panels (drill-down)?', '3., contextual, slide, out, panels, (drill, down), 02_ui_feature_catalog', '**3. Contextual Slide-Out Panels (Drill-Down)** (Source: `02_UI_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 2. dashboard module (timeline-first)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '02_UI_Feature_Catalog.md', 'KPI Proposal', 'How to 2. dashboard module (timeline-first)?', '2., dashboard, module, (timeline, first), 02_ui_feature_catalog', '**2. Dashboard Module (Timeline-First)** (Source: `02_UI_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 1. global layout & navigation?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '02_UI_Feature_Catalog.md', 'User Manual', 'How to 1. global layout & navigation?', '1., global, layout, &, navigation, 02_ui_feature_catalog', '**1. Global Layout & Navigation** (Source: `02_UI_Feature_Catalog.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to ui feature catalog: uno erp?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '02_UI_Feature_Catalog.md', 'User Manual', 'How to ui feature catalog: uno erp?', 'ui, feature, catalog:, uno, erp, 02_ui_feature_catalog', '**UI Feature Catalog: UNO ERP** (Source: `02_UI_Feature_Catalog.md`)

This document indexes all major UI modules for the Uno ERP MVP.', '/tours', 'View Tours Grid', 1, GETUTCDATE(), GETUTCDATE());
END
GO

IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 6. success criteria?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '01_Project_Charter_and_Scope.md', 'User Manual', 'How to 6. success criteria?', '6., success, criteria, 01_project_charter_and_scope', '**6. Success Criteria** (Source: `01_Project_Charter_and_Scope.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 5. architectural strategy?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '01_Project_Charter_and_Scope.md', 'User Manual', 'How to 5. architectural strategy?', '5., architectural, strategy, 01_project_charter_and_scope', '**5. Architectural Strategy** (Source: `01_Project_Charter_and_Scope.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 4. mvp scope (phase 1)?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '01_Project_Charter_and_Scope.md', 'User Manual', 'How to 4. mvp scope (phase 1)?', '4., mvp, scope, (phase, 1), 01_project_charter_and_scope', '**4. MVP Scope (Phase 1)** (Source: `01_Project_Charter_and_Scope.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How to 3. core domain concept: "the project"?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '01_Project_Charter_and_Scope.md', 'User Manual', 'How to 3. core domain concept: "the project"?', '3., core, domain, concept:, "the, project", 01_project_charter_and_scope', '**3. Core Domain Concept: "The Project"** (Source: `01_Project_Charter_and_Scope.md`)
...
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '01_Project_Charter_and_Scope.md', 'User Manual', 'How to 2. business objectives?', '2., business, objectives, 01_project_charter_and_scope', '**2. Business Objectives** (Source: `01_Project_Charter_and_Scope.md`)
...
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('DocumentationRepo', '01_Project_Charter_and_Scope.md', 'User Manual', 'How to 1. executive summary?', '1., executive, summary, 01_project_charter_and_scope', '**1. Executive Summary** (Source: `01_Project_Charter_and_Scope.md`)
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How is hotel cost calculated or why hotel calculation is wrong?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('SystemTroubleshooting', 'troubleshooting_guide.md', 'Troubleshooting', 'How is hotel cost calculated or why hotel calculation is wrong?', 'hotel, cost, calculation, calculate, wrong, price, rate, room price, fluctuate, total cost, formula', '**Troubleshooting & Explanation: Hotel Cost Calculation Formula**
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'Why added hotel expenses don''t show under Services tab?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('SystemTroubleshooting', 'troubleshooting_guide.md', 'Troubleshooting', 'Why added hotel expenses don''t show under Services tab?', 'hotel, expense, expenses, services, missing, service tab, not showing, can''t see, visibility, service, tab, issue', '**Troubleshooting: Hotel Expenses Missing under Services Tab**
...
IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How does tour calendar navigation work? / Where does the back arrow take me?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('Documentation', 'tests/e2e/test_tour_calendar_navigation.py', 'Calendar & Navigation', 'How does tour calendar navigation work? / Where does the back arrow take me?', 'calendar, tour calendar, back arrow, project id, navigation', '### Tour Navigation & Back Arrow Behavior

1. **Calendar Event Links**:
   - Clicking a tour on the calendar opens `/projects/[projectId]/tours/[tourId]` using its assigned project ID.

2. **Smart Back Arrow (`â†`)**:
   - Returns to your previous page (e.g., **Tour Calendar** if opened from calendar, or **Project Details** if opened from a project) while preserving scroll position and active filters.', '/tour-calendar', 'View Tour Calendar', 1, GETUTCDATE(), GETUTCDATE());
END
GO

IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How is invoice total amount calculated? / How to update invoice total amount?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('Documentation', 'tests/e2e/test_invoice_total_amount.py', 'Invoicing & Billing', 'How is invoice total amount calculated? / How to update invoice total amount?', 'invoice, total amount, auto sum, line items, revenue, invoicing', '### Invoice Total Amount Auto-Summing Behavior

1. **Automatic Initial Calculation**:
   - When an invoice is created for a tour, **Total Amount** automatically populates as the sum of all generated line items.

2. **1-Click Auto-Sum Button**:
   - Click the **`âš¡ Auto-Sum From Line Items`** button next to the Total Amount field to instantly recalculate and sync the invoice total whenever line items are modified.', '/invoices', 'View Invoices', 1, GETUTCDATE(), GETUTCDATE());
END
GO

IF NOT EXISTS (SELECT 1 FROM [AiKnowledgeItems] WHERE [QuestionPattern] = 'How is city tax calculated for hotels? / How does hotel tax work? / Why does city tax show 2 N?')
BEGIN
    INSERT INTO [AiKnowledgeItems] 
        ([SourceType], [SourceFile], [Category], [QuestionPattern], [Keywords], [AnswerMarkdown], [TargetUrl], [ActionLabel], [IsActive], [CreatedAt], [UpdatedAt])
    VALUES 
        ('Documentation', 'tests/e2e/test_hotel_tax.py', 'Hotel Expenses', 'How is city tax calculated for hotels? / How does hotel tax work? / Why does city tax show 2 N?', 'hotel tax, city tax, pax tax, per night, hotel expense, operational service, calculation', '### Hotel / City Tax Calculation & Display Behavior

1. **Calculation Formula**:
   - `Nightly Tax = Total Pax Ã— Tax Rate (â‚¬/pax/night)`
   - `Total Stay Tax = Total Pax Ã— Tax Rate Ã— Number of Nights` 

2. **Table Display Rules**:
   - Listed directly under **OPERATIONAL SERVICES â†’ Hotel**.
   - **Description**: `[Hotel Name] (City Tax Ã— [Pax] Pax)`
   - **QTY**: Displayed as Stay Nights (e.g. `2 N`).
   - **Unit Price**: `Total Pax Ã— Tax Rate` (e.g. `28 Pax Ã— â‚¬2.50 = â‚¬70.00`).
   - **Total**: `Total Stay Tax` (e.g. `â‚¬140.00`).', '/tour-calendar', 'View Tour Calendar', 1, GETUTCDATE(), GETUTCDATE());
END
GO
